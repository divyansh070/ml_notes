...
ax.text(1, 5.3, "$C_0 = 0$", ha='center', fontsize=16, fontweight='bold')
ax.text(12, 5.3, "$C_1 = 0.84$", ha='center', fontsize=16, fontweight='bold')
# Label formula
ax.text(6, 6, "$C_1 = (0.88 \cdot 0) + (0.88 \cdot 0.96) = 0.84$", ha='center', fontsize=14, fontweight='bold', bbox=dict(facecolor='white', edgecolor='gray', alpha=0.9, pad=3))

# Input
ax.text(6, 0.5, "$x_1 = 2$", ha='center', fontsize=16, fontweight='bold')
...
ax.text(2.2, 3, "$f_1=0.88$", fontsize=12, fontweight='bold', color='red')
...
ax.text(4.2, 3, "$i_1=0.88$", fontsize=12, fontweight='bold', color='green')

draw_arrow(ax, (7, 1.8), (7, 2.6))
draw_node(ax, 7, 3, r"$\tanh$", radius=0.3, color='#2ecc71', text_color='white', fontsize=10)
ax.text(7.8, 3, "$\tilde{C}_1=0.96$", fontsize=12, fontweight='bold', color='green')
...
ax.text(8.2, 3, "$o_1=0.88$", fontsize=12, fontweight='bold', color='blue')
...
ax.text(12, 3, "$h_1 = 0.61$", ha='center', fontsize=16, fontweight='bold')
ax.text(10, 2.2, "$0.88 \cdot \tanh(0.84)$", ha='center', fontsize=12, fontweight='bold', bbox=dict(facecolor='white', edgecolor='gray', pad=2))
...
# Base text
ax.text(6, 0.5, "$x_1 = 2$", ha='center', fontsize=14, fontweight='bold', color='gray')
ax.text(1, 5.3, "$C_0 = 0$", ha='center', fontsize=14, fontweight='bold', color='gray')

red_bbox = dict(facecolor='white', edgecolor='red', alpha=1.0, pad=3)

# 1. Error enters
ax.text(12, 3, "$dh_1 = 2$", ha='center', va='center', fontsize=16, fontweight='bold', color='red', bbox=red_bbox)
draw_arrow(ax, (11.2, 3), (10.5, 3), color='red', lw=3)

# 2. Split at mult (10, 3)
draw_arrow(ax, (10, 3.4), (10, 3.8), color='red', lw=3)
ax.text(10, 4.6, "$dC_1 = 0.92$", ha='center', va='center', fontsize=14, fontweight='bold', color='red', bbox=red_bbox, zorder=5)
draw_arrow(ax, (9.8, 5), (9.0, 5), color='red', lw=3) # flowing left

draw_arrow(ax, (9.6, 3), (9.3, 3), color='red', lw=3)
ax.text(8.3, 2.5, "$do_1 = 1.38$", ha='center', va='center', fontsize=14, fontweight='bold', color='red', bbox=red_bbox, zorder=5)

# 3. Flowing across cell state
draw_arrow(ax, (8, 5.2), (6.5, 5.2), color='red', lw=3) # Above line
ax.text(7.2, 5.5, "$dC_1 = 0.92$", ha='center', va='center', fontsize=12, fontweight='bold', color='red', bbox=red_bbox, zorder=5)

# 4. Split at addition (6, 5)
draw_arrow(ax, (5.8, 5.2), (3.5, 5.2), color='red', lw=3) # left to forget
ax.text(4.5, 5.5, "$dC_1 = 0.92$", ha='center', va='center', fontsize=12, fontweight='bold', color='red', bbox=red_bbox, zorder=5)

# 5. Forget gate error
draw_arrow(ax, (2.6, 5), (2.6, 4.4), color='red', lw=3) # down from mult
ax.text(2.6, 4, "$df_1 = 0$", ha='center', va='center', fontsize=12, fontweight='bold', color='red', bbox=red_bbox, zorder=5)
...
ax.text(4.3, 3.6, "$di_1 = 0.88$", ha='center', va='center', fontsize=12, fontweight='bold', color='red', bbox=red_bbox, zorder=5)

draw_arrow(ax, (6.3, 3.8), (7, 3.4), color='red', lw=3) # to cand
ax.text(7.7, 3.6, "$d\tilde{C}_1 = 0.81$", ha='center', va='center', fontsize=12, fontweight='bold', color='red', bbox=red_bbox, zorder=5)
